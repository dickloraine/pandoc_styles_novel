...
def latex(self):
    new = []
    if self.style == "top" and "title" in self.attributes and "author" in self.attributes:
        new.append(f'\\poemtitle*{{{self.attributes["title"]}\\\\'
                   f'\\normalfont\\textit{{\\centering{{{self.attributes["author"]}}}\\\\}}}}')
    elif self.style == "top" and "title" in self.attributes:
        new.extend([r"\poemtitle*{", self.attributes["title"], "}"])
    elif self.style == "top" and "author" in self.attributes:
